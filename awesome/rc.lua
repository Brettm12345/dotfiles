...
floating_terminal = "termite -e fish --class Diptera"
...
mymusicmenu = {
       ...
       { "mpvtube", function() awful.spawn.with_shell("mpvtube") end}
}
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        -- Method 3: Set last wallpaper with hsetroot
        -- awful.spawn.with_shell("hsetroot -fill" .. os.getenv("HOME") .. "/usr/img/gradient.jpg")
    end
end
...
awful.rules.rules = {
    ...
    }, properties = { width = 1280, height = 800 }
    },
    ...
    }, properties = { floating = true, width = 1160, height = 880 }
    },
